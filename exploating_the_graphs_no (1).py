...
for i in range (0,8735):
  if((df2['values'].iloc[i])<100):
    df2.loc[i,'values']=(df2.loc[i,'values']*10000)
  df2
...
print("\nDataFrame for 2018:")
print(df_2018)
# df_2021.to_csv('df_NO_2021.csv', index=False)
# df_2022.to_csv('df_NO_2022.csv', index=False)
