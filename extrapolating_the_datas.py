...
for i in range (5830):
  new_row_data={'date': df1_2023.iloc[i]['date'],'year': 2022,'month': df1_2023.iloc[i]['month'], 'hour':df1_2023.iloc[i]['hour'], 'values': (float(df1_2023.iloc[i]['values'])+float(df2.iloc[i]['values']))/2}
  df1_2022.loc[2904+i] = new_row_data
